/*
 * SCS.cpp
 * Feite serial servo communication layer protocol program
 * Date: 2022.3.29
 * author:
 */
#include <stdio.h>
...
//1 16-digit split into 2 8-digit
...
//2 8 digits combined into 1 16 digits
//DataL is low, DataH is high
...
//Asynchronously write and execute instructions
//Servo ID
...
/**
 *
 * @param ID        Array of Motor ID
 * @param IDN       Length of ID
 * @param MemAddr   Memory Table's Address or Register value.
 * @param nDat      Data to Write
 * @param nLen      Length of nDat
 */
 ...
 *
 * @param ID        Motor ID
 * @param MemAddr   Register Value/Memory Address
 * @param bDat      Data to write.
 * @return
 */
 ...
 *
 * @param ID        Servo ID
 * @param MemAddr   memory table address/Register
 * @param nData     data
...
//Ping command, return the servo ID, and return -1 after timeout
int SCS::Ping(u8 ID) {
    rFlushSCS();
